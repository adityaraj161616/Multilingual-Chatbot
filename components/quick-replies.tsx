...
function getQuickReplies(lang: Language) {
  const replies = {
    en: [
      ...
      { id: "2", text: "Show me the Class timetable", icon: <Calendar className="h-5 w-5" />, category: "timetable" },
    ...
    hi: [
      ...
      { id: "2", text: "कक्षा समय सारणी दिखाएं", icon: <Calendar className="h-5 w-5" />, category: "timetable" },
    ...
    ta: [
      ...
      { id: "2", text: "வகுப்பு நேர அட்டவணையைக் காட்டு", icon: <Calendar className="h-5 w-5" />, category: "timetable" },
    ...
    te: [
      ...
      { id: "2", text: "తరగతి టైమ్‌టేబుల్ చూపించు", icon: <Calendar className="h-5 w-5" />, category: "timetable" },
    ...
    bn: [
      { id: "1", text: "সেমিস্টর ফি কত?", icon: <DollarSign className="h-5 w-5" />, category: "fees" },
      { id: "2", text: "ক্লাসের সময়সূচী দেখান", icon: <Calendar className="h-5 w-5" />, category: "timetable" },
    ...
    mr: [
      ...
      { id: "2", text: "वर्ग वेळापत्रक दाखवा", icon: <Calendar className="h-5 w-5" />, category: "timetable" },
